...
function preprocess(){
    # header=${1/.c/.h}
    # echo "" > tmp_header.h
    # echo "extern FILE* stdout;" >> tmp_header.h
    # echo "extern FILE* stderr;" >> tmp_header.h
    # if [ $2 = 1 ];then
    #     cat $header tmp_header.h $1 > tmp.c
    # else
    #     cat tmp_header.h $1 > tmp.c
    # fi
    ...
    # cat result.c
    # rm tmp.c result.c tmp_header.h
    gcc -E $1
}
...
gcc -no-pie -o kfc_gen1 ${asms[@]} -std=c11 -g -static
# echo ${asms[@]}

objdump -D kfc_gen1 > kfc_gen1.s